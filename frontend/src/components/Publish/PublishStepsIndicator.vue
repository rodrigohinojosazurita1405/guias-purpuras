<!-- frontend/src/components/Publish/PublishStepsIndicator.vue -->
<!-- INDICADOR VISUAL DE PASOS DEL WIZARD -->

<template>
  <div class="publish-steps-indicator">
...
const props = defineProps({
  ...
  steps: {
    ...
    required: true,
    default: () => [
      { name: 'Selección', description: 'Tipo de trabajo' },
      { name: 'Información', description: 'Detalles básicos' },
      { name: 'Detalles', description: 'Requisitos y salario' },
      { name: 'Aplicación', description: 'Formulario de aplicación' },
      { name: 'Contacto', description: 'Información de contacto' },
      { name: 'Pago', description: 'Plan y pago' },
