<template>
  <div class="create-cv-container">
    ...
    <div class="required-fields-notice">
      ...
      <span><strong>Campos obligatorios para guardar:</strong> Nombre Completo, Teléfono y Correo Profesional</span>
    </div>
...
// Inicializar localData con props (solo una vez)
if (props.modelValue) {
  localData.value = JSON.parse(JSON.stringify(props.modelValue))
}

// Emitir cambios de local a padre
